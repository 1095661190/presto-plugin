...
public class LookupService
{
     ...
     * @throws IOException if an error occured creating the lookup service from the
     * database file.
     */
     ...
     *
     * @param databaseFile String representation of the database file.
     * @param options database flags to use when opening the database GEOIP_STANDARD
     ...
     *
     * @throws IOException if an error occurs reading from the database file.
     */
    ...
    private Location readCityRecord(int seekCountry)
            throws IOException
    {
    ...
    private ByteBuffer readRecordBuf(int seek, int maxLength)
            throws IOException
    {
    ...
    private String readOrgRecord(int seekOrg)
            throws IOException
    {
